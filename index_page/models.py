...
class Addres(models.Model):
    ...
    Owner = models.ForeignKey(People, on_delete=models.CASCADE) #The same address can belong to the same people who live in the same house. That one address belongs to many people who live in the same house
